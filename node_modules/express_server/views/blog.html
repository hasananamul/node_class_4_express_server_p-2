...
<head>
    ...
    <title>Blog | Chun Jee & Partners</title>
    ...
    <link href="css/blog/font-awesome.css" rel="stylesheet">
    <link href="css/blog/bootstrap.min.css" rel="stylesheet">

    <!-- Theme stylesheet -->
    <link href="css/blog/style.red.css" rel="stylesheet" id="theme-stylesheet">

    <!-- Custom stylesheet - for your changes -->
    <link href="css/blog/custom.css" rel="stylesheet">

    <!-- Responsivity for older IE -->
    <script src="js/blog/respond.min.js"></script>
		     ...
		     _________________________________________________________ -->
                ...
                <div class="col-sm-9" id="blog-listing">
                    ...
                    <div class="post">
                        ...
                        <div class="image">
                            <a href="post.html">
                                <img src="img/blog/blog2.jpg" class="img-responsive" alt="Example blog post alt">
                            </a>
                        </div>
                    ...
                    <div class="post">
                        ...
                        <div class="image">
                            <a href="post.html">
                                <img src="img/blog/blog.jpg" class="img-responsive" alt="Example blog post alt">
                            </a>
                        </div>
                        <p class="intro">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies
                            mi vitae est. Mauris placerat eleifend leo.</p>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="banner">
                        <a href="category.html">
                            <img src="img/blog/banner.jpg" alt="sales 2014" class="img-responsive">
                        </a>
                    </div>
                    <!-- /.banner -->
                </div>
...
_________________________________________________________ -->
    ...
    <script src="js/blog/jquery-1.11.0.min.js"></script>
    <script src="js/blog/bootstrap.min.js"></script>
    <script src="js/blog/jquery.cookie.js"></script>
    <script src="js/blog/front.js"></script>
